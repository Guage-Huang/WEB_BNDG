...
import Nearby from '@/pages/nearby/Nearby' //首页
import Order from '@/pages/order/Order' //接单
...
import NearbyCategory from '@/pages/nearby/Category' //附近列表
...
import NearbyDetailComment from '@/pages/nearby/children/Comment' //附近详情雇主评价页面
...
import UserOwner from '@/pages/user/children/owner/Owner' //会员中心-雇主注册
import LicenseAdd from '@/pages/user/children/owner/children/LicenseAdd' //会员中心-雇主注册-新增证照
import IntroduceAdd from '@/pages/user/children/owner/children/IntroduceAdd' //会员中心-雇主注册-新增企业展示
import IntroduceEdit from '@/pages/user/children/owner/children/IntroduceEdit' //会员中心-雇主注册-企业展示-修改
import UserWireman from '@/pages/user/children/wireman/Wireman' //会员中心-工匠注册
import CaseAdd from '@/pages/user/children/wireman/children/CaseAdd' //会员中心-工匠注册-新增案例
...
import SettingEaudit from '@/pages/user/children/setting/children/Eaudit' //会员中心-系统管理-工匠审核
import SettingEauditDetail from '@/pages/user/children/setting/children/Detail' //会员中心-系统管理-工匠审核-详情
import SettingOStatistics from '@/pages/user/children/setting/children/OStatistics' //会员中心-系统管理-雇主统计
import SettingEStatistics from '@/pages/user/children/setting/children/EStatistics' //会员中心-系统管理-工匠统计
...
import MapWorkers from '@/pages/map/components/Workers'
...
let routerConfig = [
  { path:'/', name:'nearby', component: Nearby, meta:{ index:0, isKeepAlive: false} },
  { path:'/order', name:'order', component: Order, meta:{index:1, title:'接单', isKeepAlive: false} },
  { path:'/release', name:'release', component: Release,meta:{index:2,title:'发布'} },
  ...
  { path:'/nearby/category', name:'nearbyCategory', component: NearbyCategory, meta:{title:'分类列表'} },
  { path:'/nearby/detail', name:'nearbyDetail', component: NearbyDetail, meta:{title:'工匠详情'} },
  { path:'/nearby/detail/project', name:'nearbyDetailProject', component: NearbyDetailProject, meta:{title:'参与项目'} },
  { path:'/nearby/detail/case', name:'nearbyDetailCase', component: NearbyDetailCase, meta:{title:'经典案例'}},
  { path:'/nearby/detail/comment', name:'nearbyDetailComment', component: NearbyDetailComment, meta:{title:'雇主评价'}},
  { path:'/user/join', name:'userJoin', component: UserJoin, meta:{title:'我的项目活动及评价'} },
  { path:'/user/owner', name:'userOwner', component: UserOwner, meta:{title:'雇主注册'}},
  ...
  { path:'/user/wireman', name:'userWireman', component: UserWireman, meta:{title:'工匠注册'} },
  ...
  { path:'/user/circle', name:'userCircle', component: UserCircle, meta:{title:'工匠圈子'} },
  { path:'/user/setting', name:'userSetting', component: UserSetting, meta:{title:'系统管理'} },
  { path:'/user/setting/eaudit', name:'settingEaudit', component: SettingEaudit, meta:{title:'工匠审核'} },
  { path:'/user/setting/eaudit/detail', name:'settingEauditDetail', component: SettingEauditDetail, meta:{title:'审核详情'} },
  { path:'/user/setting/ostatistics', name:'SettingOStatistics', component: SettingOStatistics, meta:{title:'雇主统计'} },
  { path:'/user/setting/estatistics', name:'SettingEStatistics', component: SettingEStatistics, meta:{title:'工匠统计'} },
  ...
  { path:'/clause', name:'clause', component: Clause, meta:{title:'工匠云家法律条款'} },
  { path:'/map', name:'map', component: Map, meta:{title:'地图内容'},
    children:[
      {path:'workers/:lat/:lng',component: MapWorkers,meta:{title:'工匠地图'}},
      {path:'address',component: MapAddress}
    ]
  },
